...
const useGetMapContent = (queryKey: string, lengthItem: number, countryID: number, provinceID: number) => {
    const {
        data: mainData,
        isLoading: loading,
        error,
    ...
    const filteredData = AllProvinceOFCountry?.filter((element: MapsCashType) => element.province === provinceID.toString())
