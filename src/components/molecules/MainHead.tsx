    ...
    return (
        <div
            ...
            <Container className="relative py-8">
                <div
                    className="text-4xl font-bold text-center tracking-tight mb-4 pb-[6px] text-white sm:text-5xl md:text-6xl line-clamp-1 md:line-clamp-2">
                    {title}
                </div>
                <p className="bg-gradient-to-r from-indigo-400 to-purple-300 bg-clip-text text-transparent text-center line-clamp-2 md:line-clamp-3">{description}</p>
                {createdAt && (
