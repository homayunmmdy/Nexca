        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {data?.map((artist: PostsCashType) => {
                const postLink = postLinkGenerator(artist._id, artist.title);
              return (
                <motion.div
                  key={artist._id}
                ...
                >
                  <Link href={postLink} title={artist.title} className="relative block mb-6 mx-auto w-48 h-48 aspect-square">
                    <Image
                  ...
                  <Link href={postLink} title={artist.title} className="hover:underline text-white text-xl font-bold mb-2">
                    {artist.author}
                  </Link>
