// components/LiveEvents/LiveEventsLoading.tsx
'use client';
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
               {[...Array(3)].map((_, index) => (
                  ...
                  >
                     {/* Image Skeleton */}
                     <div className="w-full h-64 bg-gradient-to-br from-gray-700 to-gray-600"></div>
...
export default LiveEventsLoading;
