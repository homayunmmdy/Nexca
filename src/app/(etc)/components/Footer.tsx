                        ...
                        <div className="block xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3">
                            ...
                            <div className="flex gap-6 xl:gap-12 max-xl:justify-center">
                                <ul className="text-gray-600 transition-all duration-500 grid gap-6">
                                    <li><Link className="link link-hover hover:text-indigo-700" href="/about">About</Link></li>
                                    <li><Link className="link link-hover hover:text-indigo-700" href="/contribution">Contribution</Link></li>
                                    <li><Link className="link link-hover hover:text-indigo-700" href="/time">Time</Link></li>
                                ...
                                <ul className="text-gray-600 transition-all duration-500 grid gap-6">
                                    ...
                                    <li><Link className="link link-hover hover:text-indigo-700" href="/tickets/new">New Ticket </Link></li>
                                    <li><Link className="link link-hover hover:text-indigo-700" href="/contacts">Contact</Link></li>
                                    <li><Link className="link link-hover hover:text-indigo-700" href="/admin">Admin</Link></li>
                                </ul>
                            </div>
                        </div>
