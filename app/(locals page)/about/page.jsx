    ...
    return (
        <div className="min-h-screen bg-white">
            <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                <h1 className="text-4xl font-bold text-gray-900 mb-8">About <Link href={SiteConfig.siteUrl} className="underline text-indigo-700" title={SiteConfig.name}>{SiteConfig.name}</Link></h1>
                <p className="mt-4 text-lg text-gray-700">
                    Welcome to <Link href={SiteConfig.siteUrl} className="underline text-indigo-700" title={SiteConfig.name}>{SiteConfig.name}</Link>! Our platform allows you to create and manage your blog website effortlessly with our powerful admin panel.
                </p>
                <h2 className="mt-8 text-2xl font-semibold text-gray-800">Our Mission</h2>
                <p className="mt-4 text-lg text-gray-700">
                    At <Link href={SiteConfig.siteUrl} className="underline text-indigo-700" title={SiteConfig.name}>{SiteConfig.name}</Link>, we aim to simplify website management, making it accessible to everyone, regardless of coding knowledge.
                </p>
